...
def dataloader(filepath):
    ...
    dwt_train   = [filepath_train+dwt_fold+img for img in train]
    ...
    dwt_val    = [filepath_train+dwt_fold+img for img in val]

    return left_train, right_train, dwt_train, disp_train, left_val, right_val, dwt_val, disp_val
